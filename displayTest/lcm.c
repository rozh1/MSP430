...
#define     LCM_PIN_EN            BIT5          // P2.5
#define     LCM_PIN_D7            BIT4          // P2.4
#define     LCM_PIN_D6            BIT3          // P2.3
#define     LCM_PIN_D5            BIT2          // P2.2
#define     LCM_PIN_D4            BIT1          // P2.1
